    ...
    IvyLeeMasterTheme {
        IvyToolbar(
            ...
            startContent = {
                Icon(
                    imageVector = IvyLogo,
                    contentDescription = "Ivy logo",
                    tint = Yellow80,
                    modifier = Modifier.size(35.dp)
                )
            },
            menuItems = listOf(
                DropDownItem(icon = Settings, title = "Settings")
            )
        )
    }
}
